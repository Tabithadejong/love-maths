...
/**
 * The main game " loop", called when the scirpt is first loaded 
...
function checkAnswer(){ 
    ...
    if (isCorrect) { 
        ...
        alert(`You asnwered ${userAnswer}. The correct answer was ${ calculatedAnswer[0]}`); 
    }
}
/**
...
function displaySubtractQuestion(operand1, operand2 ){ 
    document.getElementById('operand1').textContent = operand1 > operand2 ? operand2 : operand2;  
